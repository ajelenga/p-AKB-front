...
const About = () => {
    return (<section className="home_LOGIN">
            <Navbar/>
                    ...
                    <div className="container search_hero__content_login">
                        <div className="home-page-cars rounded overflow-hidden">
                            <div className="flex justify-center">
                                <img className="img-taille2 marginimg" src="/img/AKB_menu.png"
                                     alt="bug"/>
                            </div>
                            ...
                            <div>
                                Application de gestion de location d’automobile.Une entreprise qui possède un certain
                                nombre
                                de véhicules qui les met à la disposition des utilisateurs pour une location. Cette
                                entreprise propose à des particuliers ou professionnels la possibilité de mettre en
                                location
                            ...
                            <section className="py-6 ">
                                <div
                                    ...
                                    <p className="p-2 text-sm font-medium tracking-wider text-center uppercase">Equipe
                                        de développement</p>
                                    <h1 className="text-4xl font-bold leading-none text-center sm:text-5xl">Les
                                        personnes talentueuses en coulisses</h1>
                                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                                        <div
                                            ...
                                            <div className="flex-1 my-4">
                                                <p className="text-xl font-semibold leading-snug">Alphonse
                                                    Junior ELENGA</p>
                                                ...
                                                <a rel="noopener noreferrer" href="#" title="LinkedIn"
                                                   className="dark:text-gray-900 hover:dark:text-violet-400">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                         viewBox="0 0 32 32" className="w-5 h-5">
                                                        <path
                                        ...
                                        <div
                                            ...
                                            <div className="flex-1 my-4">
                                                <p className="text-xl font-semibold leading-snug">Kévin LOUMWANGA</p>
                                        ...
                                        <div
                                            ...
                                            <div className="flex-1 my-4">
                                                <p className="text-xl font-semibold leading-snug">Boukhalfa OUAKSEL</p>
