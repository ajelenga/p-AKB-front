...
const FormInputInsciption = (props) => {
    ...
    return (
        <div>
            <input className={`input-taille block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent
                                               ...
                                               focus:border-gray-600 peer error-input`}
...
export default FormInputInsciption;